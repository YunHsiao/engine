...
class BuiltinResMgr {
    ...
    public initBuiltinRes (device: GFXDevice) {
        ...
        // };
        // resources.push(greyCubeTexture);
        ...
        resources.push(spriteMtl);

        this._resources = resources.reduce((acc, cur) => { acc[cur._uuid] = cur; return acc; }, {});
    }
